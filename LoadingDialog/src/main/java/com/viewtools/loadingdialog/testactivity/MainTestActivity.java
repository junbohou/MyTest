...
import com.viewtools.loadingdialog.R;
import com.viewtools.loadingdialog.view.LoadingDialog;
import com.viewtools.loadingdialog.view.SizeUtils;
...
public class MainTestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.loading_test_activity_main);
        initView();
...
//                h.sendEmptyMessage(LOADING);
            ...
            ld.setOnFinishListener(new LoadingDialog.OnFinshListener() {
                ...
                public void onFinish() {
                    Toast.makeText(MainTestActivity.this, "绘制完毕", Toast.LENGTH_SHORT).show();
                }
            });
